    ...
    return (
        <div>
            ...
            <div className='container mx-auto py-10 p-5 md:p-auto'>
                ...
                <p className='font-light'>Divine Vaults and Security is a fully Licensed, Bonded and Insured Private Security Company, registered in the Republic of Ghana and a leader in high quality and effective. Treasure Trust Vaults and Security provides fully trained and screened officers and personnel to maintain secure environments for companies, residences, warehouses amongst others.</p> <br />
                ...
                <p className='font-light'>Treasure Trust Vaults and Security officers are prepared to politely handle and diffuse delicate situations, while taking a proactive stance enforcing client policy. Commitment to effective security and exceptional customer service is our hallmark.</p>
