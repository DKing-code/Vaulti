    ...
    return (
        <div>
            ...
            <div className='container mx-auto py-10 p-5 md:p-auto'>
                ...
                <p className='font-light'>Coastal Security Company is a fully Licensed, Bonded and Insured Private Security Company, registered in the Republic of Ghana and a leader in high quality and effective. Treasure Trust Vaults and Security provides fully trained and screened officers and personnel to maintain secure environments for companies, residences, warehouses amongst others.</p> <br />
